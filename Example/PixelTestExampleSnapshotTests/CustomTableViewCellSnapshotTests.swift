...
class CustomTableViewCellSnapshotTests: PixelTestCase {
    ...
    func test_regularData() {
        let viewModel = CustomTableViewCellViewModel(title: "A The best title", content: "Some amazing content")
